...
# Templates paths ############
EUDAQ2_TEMPLATE='/home/palpidefs/testbeam/TB_July_2024/config_gen/templates/babyMOSS_template_full_readout.conf'
...
VCASB_DEFAULT=70 #To be set to all other regions
###############################

# Lower level output directoreis ####
SETTINGS_DIR="psub12_full_readout" #Used to create sub directory suffix to HALF_UNIT for storing files !!!SHOULD BE CHANGED FOR EVERY SCAN!!!
