...
# Templates paths ############
EUDAQ2_TEMPLATE='/home/lennart/Downloads/config_gen/templates/babyMOSS_template_full_readout.conf'
...
VCASB_DEFUALT=10 #To be set to all regions other regions
###############################
...
CREATE_EUDAQ_DATA_DIR=True # changed from True -BaadeHals
#####################################
