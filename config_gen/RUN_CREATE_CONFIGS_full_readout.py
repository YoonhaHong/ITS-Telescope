#! /usr/bin/env python3
from create_configs_full_readout import create_configs
import argparse

# Top level output directories #########
OUTPUT_CONFIG_DIR='/home/palpidefs/testbeam/TB_August_2024/eudaq_configs' # Top level testbeam config dir
OUTPUT_DATA_DIR='/home/palpidefs/testbeam/TB_August_2024/data' # Top level testbeam data dir
TOP_RESULT_DIR=None # This should be 'None' if not used
########################################

# Templates paths ############
EUDAQ2_TEMPLATE='/home/palpidefs/testbeam/TB_August_2024/config_gen/templates/babyMOSS_template_full_readout.conf'
MOSS_TESTING_TEMPLATE='/home/palpidefs/testbeam/TB_August_2024/config_gen/templates/scan_config_template.json5'
##############################

# General MOSS settings ######
DEVICE_NAME='babyMOSS-2_2_W21D4'
HALF_UNIT='bb'
TS_CONFIG_PATH='/home/palpidefs/testbeam/TB_August_2024/sw/config/ts_config_raiser.json5'
NEVENTS=100000
...
VCASB_DEFAULT=15 #To be set to all other regions
###############################

# Lower level output directoreis ####
SETTINGS_DIR="full_rdo" #Used to create sub directory suffix to HALF_UNIT for storing files !!!SHOULD BE CHANGED FOR EVERY SCAN!!!
